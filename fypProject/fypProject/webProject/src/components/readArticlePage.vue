<template>
  ...
  <div class="home" >
    <div class="header">
      <mt-header fixed class="w3-light-gray" :title="articleName"><!--title前不加冒號會無法傳入變量articleName-->
 ...
 components:{infoCard},
  ...
  created(){
    ...
    axios.post("http://localhost:3000/getArticleName", {
      ...
      this.salesID = response.data.results[0].salesID;
      console.log(response.data.results[0].eventID);
